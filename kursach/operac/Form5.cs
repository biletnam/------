...
namespace kursach
{
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)
        {
            ...
            GetData("select * from JurnalRabot,IspolPabot,Zapis,Pacient,Uslugi,Raspisanie,Vrach,Medicament where Medicament.ID=IspolPabot.IDRashodnika AND JurnalRabot.ID=IspolPabot.IDRabot AND JurnalRabot.IDZapisi=Zapis.ID AND Zapis.IDPacienta=Pacient.ID AND Zapis.IDUslugi=Uslugi.ID AND Zapis.IDRaspisania=Raspisanie.ID AND Raspisanie.IDVrach=Vrach.ID ");
            ...
            dataGridView1.Columns[7].HeaderText = "Количество используемого";
            dataGridView1.Columns[8].Visible = false;
            dataGridView1.Columns[9].Visible = false;
            dataGridView1.Columns[10].Visible = false;
            dataGridView1.Columns[11].Visible = false;
            dataGridView1.Columns[13].HeaderText = "Дата приема";
            dataGridView1.Columns[12].Visible = false;
            dataGridView1.Columns[15].HeaderText = "ФИО пациента";
            ...
            dataGridView1.Columns[22].HeaderText = "Протезирование";
            ...
            dataGridView1.Columns[29].HeaderText = "ФИО врача";
            ...
            dataGridView1.Columns[37].HeaderText = "Наименование медикамента";
